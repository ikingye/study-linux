...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-linux/flexsearch.min.js');loadScript('/study-linux/en.search-data.min.66b67620368a05d5ed1770a69e6fae9281c65ef0f7a6eeb0492da9fb34f62fa6.js',function(){input.required=false;search();});}
