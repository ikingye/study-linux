...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-linux/flexsearch.min.js');loadScript('/study-linux/en.search-data.min.45c2ec9085ba9d8aa1510266a9276513a67f4746db4ec3dafd082120a778e32e.js',function(){input.required=false;search();});}
