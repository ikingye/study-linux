...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-linux/flexsearch.min.js');loadScript('/study-linux/en.search-data.min.f1dc10d3bc297ffcb185f77efcbdcbf747318c014d571b00e3fbe1a9eb0db459.js',function(){input.required=false;search();});}
