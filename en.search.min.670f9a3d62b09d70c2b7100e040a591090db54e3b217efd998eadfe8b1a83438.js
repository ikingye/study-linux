...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-linux/flexsearch.min.js');loadScript('/study-linux/en.search-data.min.54a1f9b79b7101ad9dcf6c1d43adac62972e405cd0ff2cbebb1fa955ee60a6a3.js',function(){input.required=false;search();});}
