...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/study-linux/flexsearch.min.js');loadScript('/study-linux/en.search-data.min.cba1e8c50ff56a3804e6abd853e9570595fed8ea14251d9a657cbcd6db93f5ab.js',function(){input.required=false;search();});}
